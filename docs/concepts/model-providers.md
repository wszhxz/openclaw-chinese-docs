...
- Cerebras: `cerebras` (`CEREBRAS_API_KEY`)
  ...
  - 与 OpenAI 兼容的基础 URL: `https://api.cerebras.ai/v1`。
...
Moonshot 使用与 OpenAI 兼容的端点，因此将其配置为自定义提供商：
