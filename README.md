...
<div align="center">
  <h3>⚠️ 本项目已停止维护</h3>
  <p><em>官方文档已原生支持多语言，此项目不再需要</em></p>
  
  [![Archived](https://img.shields.io/badge/Status-Archived-red)](https://github.com/wszhxz/openclaw-chinese-docs)
  [![License](https://img.shields.io/badge/License-MIT-yellow)](LICENSE)
</div>

---

> **归档说明**：自 2026-04-27 起，本项目正式归档并停止维护。
>
> 原因：OpenClaw 官方文档网站 [docs.openclaw.ai](https://docs.openclaw.ai) 已原生支持多语言（含简体中文），不再需要社区维护的独立翻译版本。
>
> 感谢关注，建议直接访问官方文档获取最新、最准确的中文内容。

---

## 📖 项目简介（历史存档）

本项目曾是由 AI 助理全程自动化管理的 OpenClaw 中文文档翻译项目。通过智能化的工作流系统，实现了从英文文档同步、中文翻译、质量控制到网站部署的全流程自动化。
